    ...
    items: [
      {
        ...
        medium: "Acrylic colors, pastes, inks, wood, gold paper on canvas",
        dimensions: "100 x 100 cm",
        year: "2015",
      },
      {
      ...
      {
        id: "two_languages_5",
        title: "Aljanat taht aqdam alamihat",
        description: "",
        image: "/two_languages/two_languages_5.jpg?height=600&width=800",
        medium: "Acrylic colors, fabribs, inks, wood, paper on canvas",
    ...
    items: [
      {
        ...
        medium: "Acrylic colors , inks , fabrics , wood , paper on canvas",
        dimensions: "100 x 100 cm",
        year: "2016",
      },
      {
        ...
        medium: "Acrylic colors , inks , fabrics, colage , wood , paper on canvas",
        // dimensions: "70 x 100 cm",
        year: "2023",
      },
      {
      ...
      },
      {
        ...
        medium: "Acrylic colors , Pastes , fabrics , paper on canvas",
        dimensions: "90 x 90 cm",
        year: "2016",
      },
      {
